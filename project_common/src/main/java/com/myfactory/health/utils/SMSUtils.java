...
public class SMSUtils {
	...
	public static void sendShortMessage(String templateCode,String phoneNumbers,String param) throws ClientException{
		...
		// 替换成你的AK
		final String accessKeyId = "LTAI4FxyzabaHaY8gbRXMsin";// 你的accessKeyId,参考本文档步骤2
		final String accessKeySecret = "GDh1Bs67E3Ju2UgDqVIcyH33ePZFx5";// 你的accessKeySecret，参考本文档步骤2
