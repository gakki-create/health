package com.myfactory.health.utils;
...
public class QiNiuUtils {
    ...
    private static final String ACCESSKEY = "B1OLoWhM7ZUVrtvPoEZaEStCfB6VE3VYidKCJ9k2";
    private static final String SECRETKEY = "8efiAL249M6DKhjOjfukyHNc8RWVIhFO0F8miFMo";
    private static final String BUCKET = "gakki-create";
    public static final String DOMAIN = "http://qmlvpshec.hn-bkt.clouddn.com/";
    private static long logTimestemp4Toke = 0l;
    private static String token = null;

    public static void main(String[] args) {
        uploadFile("C:\\Users\\Administrator\\Desktop\\lj.jpg","lajiao.jpg");
